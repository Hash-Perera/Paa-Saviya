...
import IconStepSmart from "../assets/images/projects/Icon- Step Smart Home Page.png";
  ...
  const upcomingProjects = [
    {
      ...
      description:
        "In partnership with D. Samson Industries (DSI) and the NIROGI project (of the Sri Lanka Medical Association) our pioneers from the University of Colombo were involved in designing, developing a diabetic foot-specific ‘BETA’ shoe that provide much required foot protection for diabetics.",
      description2:
        "To meet the needs of the local market, Paa-SAVIYA is committed to making diabetic footwear available to every patient with distinct foot structures. In line with our dedication to innovation and improvement, we are currently in the process of customizing and refining our very own diabetic footwear to better serve our patients",
      description3: "",
    },
    {
      id: 2,
